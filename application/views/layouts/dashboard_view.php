                  ...
                  <div class="card bg-c-yellow text-white">
                    <div class="card-block">
                      <div class="row align-items-center">
                        <div class="col">
                          <p class="m-b-5"><?= $karyawan['tabel']; ?></p>
                          <h4 class="m-b-0"><?= $karyawan['count']; ?></h4>
                        </div>
                ...
                <div class="col-xl-4 col-md-6">
                  <div class="card bg-c-green text-white">
                    <div class="card-block">
                      <div class="row align-items-center">
                        <div class="col">
                          <p class="m-b-5"><?= $Absensi['tabel'];?></p>
                          <h4 class="m-b-0"><?= $Absensi['count'];?></h4>
                        </div>
                        <div class="col col-auto text-right">
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="card bg-c-pink text-white">
                      <div class="card-block">
                        <div class="row align-items-center">
                          <div class="col">
                            <p class="m-b-5"><?= $Outsorsing['tabel']; ?></p>
                            <h4 class="m-b-0"><?= $Outsorsing['count'];?></h4>
                          </div>
                          <div class="col col-auto text-right">
