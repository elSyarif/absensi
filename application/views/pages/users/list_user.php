            ...
            <div class="page-body">
              ...
              <div class="card">
                <div class="card-header">
			            <a href="<?= base_url('user/create') ?>" class="btn btn-success pull-right modal-show" title="<?= $create ?>"><?= $create ?></a>
                </div>
          ...
          var j=1;
					...
					for(i=0; i<data.length; i++){
						html +='<tr>'+
									...
									'<td>'+data[i].role+'</td>'+
									'<td>'+
                    '<a href="<?= base_url("user/edit/") ?>'+data[i].id+' " class="btn btn-sm btn-info btn-outline-info modal-show edit" title="Edit '+data[i].nama+'">Edit </a>'+' '+
                    '<a href="<?= base_url("user/delete/") ?>'+data[i].id+'" class="btn-delete btn-sm btn btn-danger btn-outline-danger" title="'+data[i].nama+'">Delete</a>'+
									'</td>'+
							    '</tr>';
					}
